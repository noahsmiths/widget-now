...
- [Convex Auth v2](https://auth-v2.previews.convex.dev/) for authentication
...
For more information on how to configure Convex Auth, check out the [Convex Auth v2 docs](https://auth-v2.previews.convex.dev/).
